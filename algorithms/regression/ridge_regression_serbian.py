...
class RidgeRegressionSerbian:
    ...
    def __init__(self, training_data, testing_data, x_train, y_train, x_test, y_test):
        ...
        self.model = make_pipeline(
            ...
            Ridge(alpha=1.5, max_iter=100000, fit_intercept=False, positive=True, tol=0.0000000000001))
    ...
    def train(self):
        ...
        print()
        print("Ridge regression " + str(self.degree) + ":")
